...
export default function Saladas() {
    ...
    useEffect(() => {
        async function getDados() {
            ...
            const docRef02 = doc(db, "Receitas", "SaladaCaprese");
            const docRef03 = doc(db, "Receitas", "SaladaDeFruta");
            const docRef04 = doc(db, "Receitas", "SaladaEspinafre");
            ...
            {loading ? (
                ...
                <View style={styles.conteudo}>
                    ...
                    <View style={{ alignItems: 'baseline', justifyContent: 'center', flexDirection: 'row', paddingTop: 25 }}>
                        <Text style={styles.textNome}>Saladas</Text>
                    </View>
                    <Text style={styles.textReceita}>Lista de Receitas</Text>

                    {/* BOTÕES */}
                    {/* Receita 01 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('SaladaMolho') }>
                    ...
                    {/* Receita 02 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('SaladaCaprese') }>
                        <View style={styles.retangulo}>
                    ...
                    {/* Receita 03 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('SaladaFrutas') }>
                        <View style={styles.retangulo}>
                    ...
                    {/* Receita 04 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('SaladaEspinafre') }>
                        <View style={styles.retangulo}>
