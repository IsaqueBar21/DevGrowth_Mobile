...
export default function Pratos() {
    ...
    useEffect(() => {
        async function getDados() {
            const docRef01 = doc(db, "Receitas", "OmeleteBatataDoce");
            const docRef02 = doc(db, "Receitas", "ArrozIntegralFrangoGrelhado");
            const docRef03 = doc(db, "Receitas", "CarneMoida");
            const docRef04 = doc(db, "Receitas", "LasanhaDeBerinjela");
            ...
            {loading ? (
                ...
                <View style={styles.conteudo}>
                    ...
                    <View style={{ alignItems: 'baseline', justifyContent: 'center', flexDirection: 'row', paddingTop: 25 }}>
                        <Text style={styles.textNome}>Pratos</Text>
                    </View>
                    <Text style={styles.textReceita}>Lista de Receitas</Text>

                    {/* BOTÕES */}
                    {/* Receita 01 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('Omelete') }>
                    ...
                    {/* Receita 02 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('FrangoGrelhado') }>
                        <View style={styles.retangulo}>
                    ...
                    {/* Receita 03 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('CarneMoida') }>
                        <View style={styles.retangulo}>
