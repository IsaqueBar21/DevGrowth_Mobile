...
export default function Salgados() {
    ...
    useEffect(() => {
        async function getDados() {
            const docRef01 = doc(db, "Receitas", "CoxinhaFrango");
            const docRef02 = doc(db, "Receitas", "EmpadadeFrango");
            const docRef03 = doc(db, "Receitas", "BolinhoAtum");
            const docRef04 = doc(db, "Receitas", "BolinhoFrangoAveia");
            ...
            {loading ? (
                ...
                <View style={styles.conteudo}>
                    ...
                    <View style={{ alignItems: 'baseline', justifyContent: 'center', flexDirection: 'row', paddingTop: 25 }}>
                        <Text style={styles.textNome}>Salgados</Text>
                    </View>
                    <Text style={styles.textReceita}>Lista de Receitas</Text>

                    {/* BOTÕES */}
                    {/* Receita 01 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('CoxinhaFit') }>
                    ...
                    {/* Receita 02 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('EmpadadeFrango') }>
                        <View style={styles.retangulo}>
                    ...
                    {/* Receita 03 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('BolinhoAtum') }>
                        <View style={styles.retangulo}>
                    ...
                    {/* Receita 04 */}
                    <TouchableOpacity onPress={ () => navigation.navigate('BolinhoFrango') }>
                        <View style={styles.retangulo}>
